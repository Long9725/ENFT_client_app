...
class TicketScreenState extends State<TicketScreen>
  ...
  void initState() {
    ...
    animationOne = ColorTween(begin: kPrimaryColor, end: kPrimaryColor.shade300)
        .animate(_controller);
    animationTwo = ColorTween(begin: kPrimaryColor.shade300, end: kPrimaryColor)
        .animate(_controller);
    ...
    return Scaffold(
      ...
      child: PageView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return buildTicket(index, height, width);
        },
      ),
    )));
  }

  Widget buildTicket(int index, double height, double width) {
